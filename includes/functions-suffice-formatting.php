 ...
 *
 * Cannot use suffice_clean because it sometimes strips % chars and breaks the user's setting.
 *
 * @param  string $value
 * @return string
 */
function suffice_sanitize_permalink( $value ) {
	global $wpdb;
