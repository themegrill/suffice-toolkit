...
<script type="text/template" id="tmpl-suffice-toolkit-form-create-sidebar">
	<form class="suffice-toolkit-add-sidebar" action="<?php echo esc_url(self_admin_url( 'widgets.php' )); ?>" method="post">
		<h2><?php esc_html_e( 'Custom Widget Area Builder', 'suffice-toolkit' ) ?></h2>
