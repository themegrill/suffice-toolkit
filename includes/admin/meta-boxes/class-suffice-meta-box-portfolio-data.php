	...
	public static function output( $post ) {
		...
		<div id="portfolio_options" class="panel-wrap portfolio_data">
			<ul class="portfolio_data_tabs ft-tabs">
				<?php
					$portfolio_data_tabs = apply_filters(
						'suffice-toolkit_portfolio_data_tabs',
						array(
							'general'     => array(
				...
				foreach ( $portfolio_data_tabs as $key => $tab ) {
					?>
						<li class="<?php echo esc_attr( $key ); ?>_options <?php echo esc_attr( $key ); ?>_tab <?php echo implode( ' ', array_map( 'esc_attr', (array) $tab['class'] ) ); ?>">
			...
			<div id="general_portfolio_data" class="panel suffice_toolkit_options_panel hidden">
			<?php
				...
				echo '<div class="options_group">';
					...
					// Example Checkbox
					suffice_toolkit_wp_checkbox(
						array(
							'id'            => '_example_cb',
							'wrapper_class' => 'show_to_all_layout',
							'label'         => __( 'Sample Checkbox', 'suffice-toolkit' ),
							'description'   => __( 'Enable example checkbox.', 'suffice-toolkit' ),
						)
					);
			...
			<div id="description_portfolio_data" class="panel suffice_toolkit_options_panel hidden">
			<?php
