	...
	public static function output( $post ) {
		...
		<ul class="layout_data">
			...
			<?php
				...
				// Layout
				suffice_toolkit_wp_select(
					array(
						'id'          => 'suffice_page_layout',
						'class'       => 'select side show_if_sidebar',
						'label'       => __( 'Layout Settings', 'suffice-toolkit' ),
						'options'     => array(
						...
						'desc_class'  => 'side',
						'description' => __(
							'Select the specific layout for this entry.',
							'suffice-toolkit'
						),
					)
				);
				...
				suffice_toolkit_wp_select(
					array(
						'id'          => 'suffice_sidebar',
						'class'       => 'select side',
						'label'       => __( 'Sidebar Settings', 'suffice-toolkit' ),
						'desc_side'   => true,
						'desc_tip'    => false,
						'desc_class'  => 'side',
						'description' => __( 'Choose a custom sidebar for this entry.', 'suffice-toolkit' ),
						'options'     => suffice_toolkit_get_sidebars( array( 'default' => 'Default Sidebar' ) ),
					)
				);
				...
				suffice_toolkit_wp_select(
					array(
						'id'          => 'suffice_footer',
						'class'       => 'select side',
						'label'       => __( 'Footer Settings', 'suffice-toolkit' ),
						'options'     => array(
						...
						'desc_class'  => 'side',
						'description' => __(
							'Display the socket and footer widgets?',
							'suffice-toolkit'
						),
					)
				);
				...
				suffice_toolkit_wp_select(
					array(
						'id'          => 'suffice_transparency',
						'class'       => 'select side',
						'label'       => __( 'Header Transparency', 'suffice-toolkit' ),
						'options'     => array(
						...
						'desc_class'  => 'side',
						'description' => __(
							'Header transparency options on this page.',
							'suffice-toolkit'
						),
					)
				);
				...
				suffice_toolkit_wp_select(
					array(
						'id'          => 'suffice_top_sidebar_position',
						'class'       => 'select side',
						'label'       => __( 'Top Sidebar Position', 'suffice-toolkit' ),
						'options'     => array(
						...
						'desc_class'  => 'side',
						'description' => __(
							'Top Sidebar Position options on this page.',
							'suffice-toolkit'
						),
					)
				);
	...
	public static function save( $post_id ) {
		...
		foreach ( $layout_post_meta as $post_meta ) {
			if ( isset( $_POST[ $post_meta ] ) ) {
				update_post_meta( $post_id, $post_meta, sanitize_text_field( wp_unslash( $_POST[ $post_meta ] ) ) );
			}
		}
	}
}
